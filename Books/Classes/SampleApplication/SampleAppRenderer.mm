...
- (void) renderVideoBackground {
    ...
    Vuforia::Matrix44F vbProjectionMatrix = Vuforia::Tool::convert2GLMatrix(
        self.currentRenderingPrimitives->getVideoBackgroundProjectionMatrix(self.currentView, Vuforia::COORDINATE_SYSTEM_CAMERA));
    ...
    {
        float sceneScaleFactor = [self getSceneScaleFactorWithViewId:self.currentView];
