...
@synthesize optionsOverlayView;
@synthesize loadingView;
@synthesize closeButton;
@synthesize booksDelegate;
...
- (CGRect) rectForStatusLabelWithString:(NSString *)aString
{
    ...
    float statusLabelHeight = [aString sizeWithAttributes:@{NSFontAttributeName: statusLabelFont}].height * 2.25;
    float statusLabelWidth = [aString sizeWithAttributes:@{NSFontAttributeName: statusLabelFont}].width * 1.75;
...
- (void) addStatusLabel
{
    ...
    statusLabel = [[UILabel alloc] initWithFrame:aRect];
